...
description: |
  Provides comprehensive code review for C, C++, and Qt development.
  Helps catch bugs, improve code quality, and give constructive feedback.
  Use when: reviewing pull requests, conducting PR reviews, code review, reviewing code changes,
  establishing review standards, mentoring developers, architecture reviews, security audits,
  checking code quality, finding bugs, giving feedback on C/C++/Qt code.
allowed-tools:
  - Read
  - Grep
  - Glob
...
|-------------------|----------------|------------|
| **C** | [C Guide](reference/c.md) | 指针/缓冲区, 内存安全, UB, 错误处理, 并发, 宏陷阱 |
| **C++** | [C++ Guide](reference/cpp.md) | RAII, 生命周期, Rule of 0/3/5, 异常安全, 模板, 性能 |
...
- [Performance Review Guide](reference/performance-review-guide.md) - 性能审查指南（算法复杂度、内存使用、缓存）
