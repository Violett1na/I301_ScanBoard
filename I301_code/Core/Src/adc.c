...
void HAL_ADC_MspInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  */
    ...
    PA3     ------> ADC1_IN4
    */
    GPIO_InitStruct.Pin = ADC_FBX_Pin|ADC_FBY_Pin;
  ...
  */
    ...
    PA0     ------> ADC2_IN1
    */
    GPIO_InitStruct.Pin = ADC_IX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_PULLDOWN;
    HAL_GPIO_Init(ADC_IX_GPIO_Port, &GPIO_InitStruct);
  ...
  */
    ...
    PB13     ------> ADC3_IN5
    */
    GPIO_InitStruct.Pin = ADC_VX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_PULLDOWN;
    HAL_GPIO_Init(ADC_VX_GPIO_Port, &GPIO_InitStruct);
  ...
  */
    ...
    PB15     ------> ADC4_IN5
    */
    GPIO_InitStruct.Pin = ADC_VY_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_PULLDOWN;
    HAL_GPIO_Init(ADC_VY_GPIO_Port, &GPIO_InitStruct);
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PA3     ------> ADC1_IN4
    */
    HAL_GPIO_DeInit(GPIOA, ADC_FBX_Pin|ADC_FBY_Pin);
  ...
  /* USER CODE END ADC2_MspDeInit 0 */
    ...
    PA0     ------> ADC2_IN1
    */
    HAL_GPIO_DeInit(ADC_IX_GPIO_Port, ADC_IX_Pin);
  ...
  /* USER CODE END ADC3_MspDeInit 0 */
    ...
    PB13     ------> ADC3_IN5
    */
    HAL_GPIO_DeInit(ADC_VX_GPIO_Port, ADC_VX_Pin);
  ...
  /* USER CODE END ADC4_MspDeInit 0 */
    ...
    PB15     ------> ADC4_IN5
    */
    HAL_GPIO_DeInit(ADC_VY_GPIO_Port, ADC_VY_Pin);
