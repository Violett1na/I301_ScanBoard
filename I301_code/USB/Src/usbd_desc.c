...
#define USBD_VID                         0x5678
#define USBD_LANGID_STRING               1033
#define USBD_MANUFACTURER_STRING         "LIGHTSPACE SCANXY-268"
#define USBD_PID_FS                      0x4321
#define USBD_PRODUCT_STRING_FS           "LIGHTSPACE Bulk Device"
#define USBD_CONFIGURATION_STRING_FS     "Bulk Config"
#define USBD_INTERFACE_STRING_FS         "Bulk Interface"

#define USB_SIZ_BOS_DESC                  0x28
#define WINUSB_VENDOR_CODE                0x20
#define WINUSB_DESCRIPTOR_SET_LENGTH      0x00B2
...
__ALIGN_BEGIN uint8_t USBD_FS_BOSDesc[USB_SIZ_BOS_DESC] __ALIGN_END =
{
  ...
  0x02, 0x00, 0x00, 0x00,       /* bmAttributes = LPM */
  ...
  LOBYTE(WINUSB_DESCRIPTOR_SET_LENGTH),
  HIBYTE(WINUSB_DESCRIPTOR_SET_LENGTH),
